        ...
        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6 justify-center items-stretch">
          ...
          <div className="p-4 md:w-1/3 w-full flex flex-col text-center items-center pt-6">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Enjoy fast, free delivery on all orders above $500. Shop your
                favorites now and get them delivered straight to your doorstep!
                We ensure quick and reliable delivery, so you can focus on
                enjoying your new purchases.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 md:w-1/3 w-full flex flex-col text-center items-center px-8 pt-11">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Shop with confidence! We offer a full money-back guarantee on
                all purchases. If you&apos;re not completely satisfied with your
                order, return it within 30 days for a full refund. Your
          ...
          <div className="p-4 md:w-1/3 w-full flex flex-col text-center items-center pt-14">
            <Image
              src="/24-hours-services.png"
              alt="24-hour services"
              width={210}
              height={210}
              className="rounded-full"
            />
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                We&apos;re here for you around the clock! Enjoy 24-hour customer
                support and services, ensuring your questions and needs are met
                anytime. Shop with confidence knowing help is just a click away,
